     ...
     <div className="container">
      <div className="aa-catg-head-banner-content">
        ...
        <ol className="breadcrumb">
          ...
          <li className="active">Barrels</li>
        </ol>
      </div>
     </div>
   </div>
          ...
          <div className="aa-product-catg-content">
            ...
            <div className="aa-product-catg-body">
              <ul className="aa-product-catg">
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/barrels/barrel0.jpg" alt="polo shirt img" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Barrel</Link></h4>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/barrels/barrel1.png" alt="polo shirt img" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Barrel</Link></h4>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/barrels/barrel2.jpg" alt="polo shirt img" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Barrel</Link></h4>
                      <span className="aa-product-price">$$.$$</span>
