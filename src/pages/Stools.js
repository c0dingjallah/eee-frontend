          ...
          <div className="aa-product-catg-content">
            ...
            <div className="aa-product-catg-body">
              <ul className="aa-product-catg">
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/stools/stool1.jpg" alt="tool img 1" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Stool</Link></h4>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/stools/stool2.jpg" alt="stool img 2" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Stool</Link></h4>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/stools/stool3.jpg" alt="stool img 3" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Stool</Link></h4>
                      <span className="aa-product-price">$$.$$</span>
