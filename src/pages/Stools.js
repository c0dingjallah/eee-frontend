          ...
          <div className="aa-product-catg-content">
            ...
            <div className="aa-product-catg-body">
              <ul className="aa-product-catg">
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="/Detail/stools/stool1.jpg"><img src="img/stools/stool1.jpg" alt="tool img 1" /></Link>
                    <Link className="aa-add-card-btn"to="/Detail/stools/stool1.jpg"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="/Detail/stools/stool1.jpg">Stool</Link></h4>
                  ...
                  <div className="aa-product-hvr-content">
                    <Link to="/Detail/stools/stool1.jpg" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span className="fa fa-heart-o"></span></Link>
                    <Link to="/Detail/stools/stool1.jpg" data-toggle="tooltip" data-placement="top" title="Compare"><span className="fa fa-exchange"></span></Link>
                    <Link to="/Detail/stools/stool1.jpg" data-toggle2="tooltip" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal"><span className="fa fa-search"></span></Link>                            
                  </div>
                  {/* product badge */}
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="/Detail/stools/stool2.jpg"><img src="img/stools/stool2.jpg" alt="stool img 2" /></Link>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="/Detail/stools/stool3.jpg"><img src="img/stools/stool3.jpg" alt="stool img 3" /></Link>
