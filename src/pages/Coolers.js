          ...
          <div className="aa-product-catg-content">
            ...
            <div className="aa-product-catg-body">
              <ul className="aa-product-catg">
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/coolers/cooler1.jpg" alt="polo shirt img" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Cooler</Link></h4>
                ...
                <li>
                  <figure>
                    <Link className="aa-product-img" to="#"><img src="img/coolers/cooler2.jpg" alt="polo shirt img" /></Link>
                    <Link className="aa-add-card-btn"to="#"><span className="fa fa-shopping-cart"></span>Rent Now</Link>
                    <figcaption>
                      <h4 className="aa-product-title"><Link to="#">Cooler</Link></h4>
